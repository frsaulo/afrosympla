    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('hasSeatingPlan', ChoiceType::class, [
                    ...
                    'multiple' => false,
                    'expanded' => true,
                    'label' => 'Does this event date has a seating plan ?',
                    'choices' => ['No' => false, 'Yes' => true],
                    'attr' => ['class' => 'event-date-has-seating-plan'],
                    'label_attr' => ['class' => 'radio-custom radio-inline']
                ])
                ...
                ->add('seatingPlan', EntityType::class, [
                    ...
                    'label' => 'Seating plan',
                    'attr' => ['class' => 'event-date-seating-plan'],
                    'query_builder' => function () {
                        return $this->services->getVenuesSeatingPlans(array("organizer" => $this->user->getOrganizer()->getSlug()));
                    },
                ])
