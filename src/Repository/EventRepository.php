...
class EventRepository extends ServiceEntityRepository {
    ...
    public function getEvents($category, $venue, $country, $location, $organizer, $keyword, $slug, $freeonly, $onlineonly, $pricemin, $pricemax, $audience, $startdate, $startdatemin, $startdatemax, $published, $elapsed, $organizerEnabled, $addedtofavoritesby, $onsalebypos, $canbescannedby, $isOnHomepageSlider, $otherthan, $notId, $sort, $order, $limit, $count) {
        ...
        if ($notId !== "all") {
            $qb->andWhere("e.id != :notId")->setParameter("notId", $notId);
        }
        if ($elapsed !== "all") {
