 ...
 * @ORM\Table(name="AfroSympla_event")
...
class Event {
     ...
     * @ORM\JoinTable(name="AfroSympla_event_language",
     ...
     * @ORM\JoinTable(name="AfroSympla_event_subtitle",
     *   joinColumns={@ORM\JoinColumn(name="Event_id", referencedColumnName="id")},
     *   inverseJoinColumns={@ORM\JoinColumn(name="Language_Id", referencedColumnName="id")}
     * )
     */
     ...
     * @ORM\JoinTable(name="AfroSympla_event_audience",
     *   joinColumns={@ORM\JoinColumn(name="Event_id", referencedColumnName="id")},
     ...
     * @ORM\JoinTable(name="AfroSympla_favorites",
     *   joinColumns={@ORM\JoinColumn(name="Event_id", referencedColumnName="id")},
