...
--
-- Table structure for table `AfroSympla_amenity`
--

DROP TABLE IF EXISTS `AfroSympla_amenity`;
CREATE TABLE IF NOT EXISTS `AfroSympla_amenity` (
...
--
-- Dumping data for table `AfroSympla_amenity`
--

INSERT INTO `AfroSympla_amenity` (`id`, `icon`, `hidden`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_amenity_translation`
--

DROP TABLE IF EXISTS `AfroSympla_amenity_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_amenity_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `AfroSympla_amenity_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_3C354FF82C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_amenity_translation`
--

INSERT INTO `AfroSympla_amenity_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
(21, 5, 'Spa', 'spa', 'en'),
(22, 5, '温泉', '温泉', 'zh'),
(23, 5, 'Spa', 'spa-1', 'es'),
(24, 5, 'Spa', 'spa-2', 'fr'),
...
--
-- Table structure for table `AfroSympla_app_layout_setting`
--

DROP TABLE IF EXISTS `AfroSympla_app_layout_setting`;
CREATE TABLE IF NOT EXISTS `AfroSympla_app_layout_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_audience`
--

DROP TABLE IF EXISTS `AfroSympla_audience`;
CREATE TABLE IF NOT EXISTS `AfroSympla_audience` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `AfroSympla_audience`
--

INSERT INTO `AfroSympla_audience` (`id`, `image_name`, `image_size`, `image_mime_type`, `image_original_name`, `image_dimensions`, `hidden`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_audience_translation`
--

DROP TABLE IF EXISTS `AfroSympla_audience_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_audience_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_audience_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_5CF81D362C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_audience_translation`
--

INSERT INTO `AfroSympla_audience_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_blog_post`
--

DROP TABLE IF EXISTS `AfroSympla_blog_post`;
CREATE TABLE IF NOT EXISTS `AfroSympla_blog_post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_blog_post_category`
--

DROP TABLE IF EXISTS `AfroSympla_blog_post_category`;
CREATE TABLE IF NOT EXISTS `AfroSympla_blog_post_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hidden` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `AfroSympla_blog_post_category`
--

INSERT INTO `AfroSympla_blog_post_category` (`id`, `hidden`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_blog_post_category_translation`
--

DROP TABLE IF EXISTS `AfroSympla_blog_post_category_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_blog_post_category_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_blog_post_category_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_BAF151EA2C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_blog_post_category_translation`
--

INSERT INTO `AfroSympla_blog_post_category_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_blog_post_translation`
--

DROP TABLE IF EXISTS `AfroSympla_blog_post_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_blog_post_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `AfroSympla_blog_post_translation_unique_translation` (`translatable_id`,`locale`),
...
--
-- Table structure for table `AfroSympla_cart_element`
--

DROP TABLE IF EXISTS `AfroSympla_cart_element`;
CREATE TABLE IF NOT EXISTS `AfroSympla_cart_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_category`
--

DROP TABLE IF EXISTS `AfroSympla_category`;
CREATE TABLE IF NOT EXISTS `AfroSympla_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `icon` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `image_name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `image_size` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `AfroSympla_category`
--

INSERT INTO `AfroSympla_category` (`id`, `icon`, `image_name`, `image_size`, `image_mime_type`, `image_original_name`, `image_dimensions`, `hidden`, `featured`, `featuredorder`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_category_translation`
--

DROP TABLE IF EXISTS `AfroSympla_category_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_category_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_category_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_3CFC55AB2C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_category_translation`
--

INSERT INTO `AfroSympla_category_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_comment`
--

DROP TABLE IF EXISTS `AfroSympla_comment`;
CREATE TABLE IF NOT EXISTS `AfroSympla_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_country`
--

DROP TABLE IF EXISTS `AfroSympla_country`;
CREATE TABLE IF NOT EXISTS `AfroSympla_country` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `AfroSympla_country`
--

INSERT INTO `AfroSympla_country` (`id`, `code`, `hidden`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_country_translation`
--

DROP TABLE IF EXISTS `AfroSympla_country_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_country_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_country_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_1AAA1D022C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1246 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_country_translation`
--

INSERT INTO `AfroSympla_country_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_currency`
--

DROP TABLE IF EXISTS `AfroSympla_currency`;
CREATE TABLE IF NOT EXISTS `AfroSympla_currency` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `AfroSympla_currency`
--

INSERT INTO `AfroSympla_currency` (`id`, `ccy`, `symbol`) VALUES
(1, 'AED', 'د.إ'),
(2, 'AFN', 'Af'),
(3, 'ALL', 'L'),
(4, 'AMD', 'Դ'),
...
--
-- Table structure for table `AfroSympla_event`
--

DROP TABLE IF EXISTS `AfroSympla_event`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_eventdate_pointofsale`
--

DROP TABLE IF EXISTS `AfroSympla_eventdate_pointofsale`;
CREATE TABLE IF NOT EXISTS `AfroSympla_eventdate_pointofsale` (
...
--
-- Table structure for table `AfroSympla_eventdate_scanner`
--

DROP TABLE IF EXISTS `AfroSympla_eventdate_scanner`;
CREATE TABLE IF NOT EXISTS `AfroSympla_eventdate_scanner` (
  `eventdate_id` int(11) NOT NULL,
...
--
-- Table structure for table `AfroSympla_event_audience`
--

DROP TABLE IF EXISTS `AfroSympla_event_audience`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event_audience` (
...
--
-- Table structure for table `AfroSympla_event_date`
--

DROP TABLE IF EXISTS `AfroSympla_event_date`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event_date` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_event_date_ticket`
--

DROP TABLE IF EXISTS `AfroSympla_event_date_ticket`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event_date_ticket` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_event_image`
--

DROP TABLE IF EXISTS `AfroSympla_event_image`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `event_id` int(11) DEFAULT NULL,
  `image_name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `image_size` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_event_language`
--

DROP TABLE IF EXISTS `AfroSympla_event_language`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event_language` (
  `Event_id` int(11) NOT NULL,
...
--
-- Table structure for table `AfroSympla_event_subtitle`
--

DROP TABLE IF EXISTS `AfroSympla_event_subtitle`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event_subtitle` (
  `Event_id` int(11) NOT NULL,
  `Language_Id` int(11) NOT NULL,
  PRIMARY KEY (`Event_id`,`Language_Id`),
...
--
-- Table structure for table `AfroSympla_event_translation`
--

DROP TABLE IF EXISTS `AfroSympla_event_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_event_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `AfroSympla_event_translation_unique_translation` (`translatable_id`,`locale`),
...
--
-- Table structure for table `AfroSympla_favorites`
--

DROP TABLE IF EXISTS `AfroSympla_favorites`;
CREATE TABLE IF NOT EXISTS `AfroSympla_favorites` (
  `Event_id` int(11) NOT NULL,
...
--
-- Table structure for table `AfroSympla_following`
--

DROP TABLE IF EXISTS `AfroSympla_following`;
CREATE TABLE IF NOT EXISTS `AfroSympla_following` (
...
--
-- Table structure for table `AfroSympla_help_center_article`
--

DROP TABLE IF EXISTS `AfroSympla_help_center_article`;
CREATE TABLE IF NOT EXISTS `AfroSympla_help_center_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) DEFAULT NULL,
  `views` int(11) DEFAULT NULL,
  `hidden` tinyint(1) NOT NULL,
...
--
-- Table structure for table `AfroSympla_help_center_article_translation`
--

DROP TABLE IF EXISTS `AfroSympla_help_center_article_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_help_center_article_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `AfroSympla_help_center_article_translation_unique_translation` (`translatable_id`,`locale`),
...
--
-- Table structure for table `AfroSympla_help_center_category`
--

DROP TABLE IF EXISTS `AfroSympla_help_center_category`;
CREATE TABLE IF NOT EXISTS `AfroSympla_help_center_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `AfroSympla_help_center_category`
--

INSERT INTO `AfroSympla_help_center_category` (`id`, `parent_id`, `icon`, `hidden`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_help_center_category_translation`
--

DROP TABLE IF EXISTS `AfroSympla_help_center_category_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_help_center_category_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_help_center_category_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_2B8AFEF52C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_help_center_category_translation`
--

INSERT INTO `AfroSympla_help_center_category_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_homepage_hero_setting`
--

DROP TABLE IF EXISTS `AfroSympla_homepage_hero_setting`;
CREATE TABLE IF NOT EXISTS `AfroSympla_homepage_hero_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `AfroSympla_homepage_hero_setting`
--

INSERT INTO `AfroSympla_homepage_hero_setting` (`id`, `content`, `custom_background_name`, `custom_background_size`, `custom_background_mime_type`, `custom_background_original_name`, `custom_background_dimensions`, `show_search_box`, `updated_at`) VALUES
...
--
-- Table structure for table `AfroSympla_homepage_hero_setting_translation`
--

DROP TABLE IF EXISTS `AfroSympla_homepage_hero_setting_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_homepage_hero_setting_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  ...
  `locale` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `AfroSympla_homepage_hero_setting_translation_unique_translation` (`translatable_id`,`locale`),
...
--
-- Dumping data for table `AfroSympla_homepage_hero_setting_translation`
--

INSERT INTO `AfroSympla_homepage_hero_setting_translation` (`id`, `translatable_id`, `title`, `paragraph`, `locale`) VALUES
(1, 1, 'AfroSympla', 'Online Event Management And Ticket Sales', 'en'),
(2, 1, 'AfroSympla', '在线活动管理和门票销售', 'zh'),
(3, 1, 'AfroSympla', 'Gestión de eventos en línea y venta de entradas', 'es'),
(4, 1, 'AfroSympla', 'Gestion d\'événements en ligne et vente de billets', 'fr'),
(5, 1, 'AfroSympla', 'إدارة الأحداث عبر الإنترنت ومبيعات التذاكر', 'ar');

--
-- Table structure for table `AfroSympla_language`
--

DROP TABLE IF EXISTS `AfroSympla_language`;
CREATE TABLE IF NOT EXISTS `AfroSympla_language` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `hidden` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
...
--
-- Dumping data for table `AfroSympla_language`
--

INSERT INTO `AfroSympla_language` (`id`, `code`, `hidden`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_language_translation`
--

DROP TABLE IF EXISTS `AfroSympla_language_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_language_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_language_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_E82162722C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=676 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_language_translation`
--

INSERT INTO `AfroSympla_language_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_order`
--

DROP TABLE IF EXISTS `AfroSympla_order`;
CREATE TABLE IF NOT EXISTS `AfroSympla_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_order_element`
--

DROP TABLE IF EXISTS `AfroSympla_order_element`;
CREATE TABLE IF NOT EXISTS `AfroSympla_order_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_order_ticket`
--

DROP TABLE IF EXISTS `AfroSympla_order_ticket`;
CREATE TABLE IF NOT EXISTS `AfroSympla_order_ticket` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_organizer`
--

DROP TABLE IF EXISTS `AfroSympla_organizer`;
CREATE TABLE IF NOT EXISTS `AfroSympla_organizer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `country_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_organizer_category`
--

DROP TABLE IF EXISTS `AfroSympla_organizer_category`;
CREATE TABLE IF NOT EXISTS `AfroSympla_organizer_category` (
  `Organizer_id` int(11) NOT NULL,
...
--
-- Table structure for table `AfroSympla_page`
--

DROP TABLE IF EXISTS `AfroSympla_page`;
CREATE TABLE IF NOT EXISTS `AfroSympla_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `AfroSympla_page`
--

INSERT INTO `AfroSympla_page` (`id`, `updated_at`) VALUES
...
--
-- Table structure for table `AfroSympla_page_translation`
--

DROP TABLE IF EXISTS `AfroSympla_page_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_page_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `AfroSympla_page_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_3B97CBF22C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_page_translation`
--

INSERT INTO `AfroSympla_page_translation` (`id`, `translatable_id`, `title`, `slug`, `content`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_payment`
--

DROP TABLE IF EXISTS `AfroSympla_payment`;
CREATE TABLE IF NOT EXISTS `AfroSympla_payment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
  `country_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_payment_gateway`
--

DROP TABLE IF EXISTS `AfroSympla_payment_gateway`;
CREATE TABLE IF NOT EXISTS `AfroSympla_payment_gateway` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organizer_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `AfroSympla_payment_gateway`
--

INSERT INTO `AfroSympla_payment_gateway` (`id`, `organizer_id`, `gateway_name`, `factory_name`, `config`, `name`, `slug`, `gateway_logo_name`, `enabled`, `number`, `updated_at`) VALUES
...
--
-- Table structure for table `AfroSympla_payment_token`
--

DROP TABLE IF EXISTS `AfroSympla_payment_token`;
CREATE TABLE IF NOT EXISTS `AfroSympla_payment_token` (
...
--
-- Table structure for table `AfroSympla_payout_request`
--

DROP TABLE IF EXISTS `AfroSympla_payout_request`;
CREATE TABLE IF NOT EXISTS `AfroSympla_payout_request` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organizer_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_pointofsale`
--

DROP TABLE IF EXISTS `AfroSympla_pointofsale`;
CREATE TABLE IF NOT EXISTS `AfroSympla_pointofsale` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organizer_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `name` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `AfroSympla_review`
--

DROP TABLE IF EXISTS `AfroSympla_review`;
CREATE TABLE IF NOT EXISTS `AfroSympla_review` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `event_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_scanner`
--

DROP TABLE IF EXISTS `AfroSympla_scanner`;
CREATE TABLE IF NOT EXISTS `AfroSympla_scanner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organizer_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `name` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `AfroSympla_settings`
--

DROP TABLE IF EXISTS `AfroSympla_settings`;
CREATE TABLE IF NOT EXISTS `AfroSympla_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `AfroSympla_settings`
--

INSERT INTO `AfroSympla_settings` (`id`, `key`, `value`) VALUES
(1, 'currency_ccy', 'USD'),
(2, 'currency_symbol', '$'),
...
(51, 'website_name', 'AfroSympla'),
(52, 'website_slug', 'AfroSympla'),
...
--
-- Table structure for table `AfroSympla_thread`
--

DROP TABLE IF EXISTS `AfroSympla_thread`;
CREATE TABLE IF NOT EXISTS `AfroSympla_thread` (
...
--
-- Table structure for table `AfroSympla_ticket_reservation`
--

DROP TABLE IF EXISTS `AfroSympla_ticket_reservation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_ticket_reservation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `eventticket_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `orderelement_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_user`
--

DROP TABLE IF EXISTS `AfroSympla_user`;
CREATE TABLE IF NOT EXISTS `AfroSympla_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organizer_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `AfroSympla_user`
--

INSERT INTO `AfroSympla_user` (`id`, `organizer_id`, `scanner_id`, `pointofsale_id`, `isorganizeronhomepageslider_id`, `country_id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `gender`, `firstname`, `lastname`, `slug`, `street`, `street2`, `city`, `state`, `postalcode`, `phone`, `birthdate`, `avatar_name`, `avatar_size`, `avatar_mime_type`, `avatar_original_name`, `avatar_dimensions`, `created_at`, `updated_at`, `deleted_at`, `facebook_id`, `facebook_access_token`, `google_id`, `google_access_token`, `api_key`, `facebook_profile_picture`) VALUES
...
--
-- Table structure for table `AfroSympla_venue`
--

DROP TABLE IF EXISTS `AfroSympla_venue`;
CREATE TABLE IF NOT EXISTS `AfroSympla_venue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organizer_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_venue_amenity`
--

DROP TABLE IF EXISTS `AfroSympla_venue_amenity`;
CREATE TABLE IF NOT EXISTS `AfroSympla_venue_amenity` (
...
--
-- Table structure for table `AfroSympla_venue_image`
--

DROP TABLE IF EXISTS `AfroSympla_venue_image`;
CREATE TABLE IF NOT EXISTS `AfroSympla_venue_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `venue_id` int(11) DEFAULT NULL,
  `image_name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `image_size` int(11) DEFAULT NULL,
...
--
-- Table structure for table `AfroSympla_venue_translation`
--

DROP TABLE IF EXISTS `AfroSympla_venue_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_venue_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_venue_translation_unique_translation` (`translatable_id`,`locale`),
...
--
-- Table structure for table `AfroSympla_venue_type`
--

DROP TABLE IF EXISTS `AfroSympla_venue_type`;
CREATE TABLE IF NOT EXISTS `AfroSympla_venue_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hidden` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `AfroSympla_venue_type`
--

INSERT INTO `AfroSympla_venue_type` (`id`, `hidden`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Table structure for table `AfroSympla_venue_type_translation`
--

DROP TABLE IF EXISTS `AfroSympla_venue_type_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_venue_type_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_venue_type_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_9FD9786F2C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_venue_type_translation`
--

INSERT INTO `AfroSympla_venue_type_translation` (`id`, `translatable_id`, `name`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_vote`
--

DROP TABLE IF EXISTS `AfroSympla_vote`;
CREATE TABLE IF NOT EXISTS `AfroSympla_vote` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `AfroSympla_menu`
--

DROP TABLE IF EXISTS `AfroSympla_menu`;
CREATE TABLE IF NOT EXISTS `AfroSympla_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_menu`
--

INSERT INTO `AfroSympla_menu` (`id`) VALUES
(1),
(2),
(3),
(4);
...
--
-- Table structure for table `AfroSympla_menu_translation`
--

DROP TABLE IF EXISTS `AfroSympla_menu_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_menu_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `AfroSympla_menu_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_44D78BCC2C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_menu_translation`
--

INSERT INTO `AfroSympla_menu_translation` (`id`, `translatable_id`, `name`, `header`, `slug`, `locale`) VALUES
...
--
-- Table structure for table `AfroSympla_menu_element`
--

DROP TABLE IF EXISTS `AfroSympla_menu_element`;
CREATE TABLE IF NOT EXISTS `AfroSympla_menu_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `AfroSympla_menu_element`
--

INSERT INTO `AfroSympla_menu_element` (`id`, `menu_id`, `icon`, `link`, `position`, `custom_link`) VALUES
...
--
-- Table structure for table `AfroSympla_menu_element_translation`
--

DROP TABLE IF EXISTS `AfroSympla_menu_element_translation`;
CREATE TABLE IF NOT EXISTS `AfroSympla_menu_element_translation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `translatable_id` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `AfroSympla_menu_element_translation_unique_translation` (`translatable_id`,`locale`),
  KEY `IDX_CEDB3B232C2AC5D3` (`translatable_id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `AfroSympla_menu_element_translation`
--

INSERT INTO `AfroSympla_menu_element_translation` (`id`, `translatable_id`, `label`, `slug`, `locale`) VALUES
(1, 1, 'Home', 'home', 'en'),
...
--
-- Constraints for table `AfroSympla_amenity_translation`
--
ALTER TABLE `AfroSympla_amenity_translation`
  ADD CONSTRAINT `FK_3C354FF82C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_amenity` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_audience_translation`
--
ALTER TABLE `AfroSympla_audience_translation`
  ADD CONSTRAINT `FK_5CF81D362C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_audience` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_blog_post`
--
ALTER TABLE `AfroSympla_blog_post`
  ADD CONSTRAINT `FK_E66028C712469DE2` FOREIGN KEY (`category_id`) REFERENCES `AfroSympla_blog_post_category` (`id`);

--
-- Constraints for table `AfroSympla_blog_post_category_translation`
--
ALTER TABLE `AfroSympla_blog_post_category_translation`
  ADD CONSTRAINT `FK_BAF151EA2C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_blog_post_category` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_blog_post_translation`
--
ALTER TABLE `AfroSympla_blog_post_translation`
  ADD CONSTRAINT `FK_6A7C548D2C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_blog_post` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_cart_element`
--
ALTER TABLE `AfroSympla_cart_element`
  ADD CONSTRAINT `FK_FFABA270182CEB62` FOREIGN KEY (`eventticket_id`) REFERENCES `AfroSympla_event_date_ticket` (`id`),
  ADD CONSTRAINT `FK_FFABA270A76ED395` FOREIGN KEY (`user_id`) REFERENCES `AfroSympla_user` (`id`);

--
-- Constraints for table `AfroSympla_category_translation`
--
ALTER TABLE `AfroSympla_category_translation`
  ADD CONSTRAINT `FK_3CFC55AB2C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_category` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_comment`
--
ALTER TABLE `AfroSympla_comment`
  ADD CONSTRAINT `FK_E58109F5E2904019` FOREIGN KEY (`thread_id`) REFERENCES `AfroSympla_thread` (`id`),
  ADD CONSTRAINT `FK_E58109F5F675F31B` FOREIGN KEY (`author_id`) REFERENCES `AfroSympla_user` (`id`);

--
-- Constraints for table `AfroSympla_country_translation`
--
ALTER TABLE `AfroSympla_country_translation`
  ADD CONSTRAINT `FK_1AAA1D022C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_country` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_event`
--
ALTER TABLE `AfroSympla_event`
  ADD CONSTRAINT `FK_E1933DCB12469DE2` FOREIGN KEY (`category_id`) REFERENCES `AfroSympla_category` (`id`),
  ADD CONSTRAINT `FK_E1933DCB376C51EF` FOREIGN KEY (`isonhomepageslider_id`) REFERENCES `AfroSympla_homepage_hero_setting` (`id`),
  ADD CONSTRAINT `FK_E1933DCB876C4DDA` FOREIGN KEY (`organizer_id`) REFERENCES `AfroSympla_organizer` (`id`),
  ADD CONSTRAINT `FK_E1933DCBF92F3E70` FOREIGN KEY (`country_id`) REFERENCES `AfroSympla_country` (`id`);

--
-- Constraints for table `AfroSympla_eventdate_pointofsale`
--
ALTER TABLE `AfroSympla_eventdate_pointofsale`
  ADD CONSTRAINT `FK_7E37EBFC18E07BF3` FOREIGN KEY (`pointofsale_id`) REFERENCES `AfroSympla_pointofsale` (`id`),
  ADD CONSTRAINT `FK_7E37EBFC733DA6BA` FOREIGN KEY (`eventdate_id`) REFERENCES `AfroSympla_event_date` (`id`);

--
-- Constraints for table `AfroSympla_eventdate_scanner`
--
ALTER TABLE `AfroSympla_eventdate_scanner`
  ADD CONSTRAINT `FK_A911049367C89E33` FOREIGN KEY (`scanner_id`) REFERENCES `AfroSympla_scanner` (`id`),
  ADD CONSTRAINT `FK_A9110493733DA6BA` FOREIGN KEY (`eventdate_id`) REFERENCES `AfroSympla_event_date` (`id`);

--
-- Constraints for table `AfroSympla_event_audience`
--
ALTER TABLE `AfroSympla_event_audience`
  ADD CONSTRAINT `FK_F46FAEC788818ADD` FOREIGN KEY (`Event_id`) REFERENCES `AfroSympla_event` (`id`),
  ADD CONSTRAINT `FK_F46FAEC797946D63` FOREIGN KEY (`Audience_Id`) REFERENCES `AfroSympla_audience` (`id`);

--
-- Constraints for table `AfroSympla_event_date`
--
ALTER TABLE `AfroSympla_event_date`
  ADD CONSTRAINT `FK_D30F7AD340A73EBA` FOREIGN KEY (`venue_id`) REFERENCES `AfroSympla_venue` (`id`),
  ADD CONSTRAINT `FK_D30F7AD371F7E88B` FOREIGN KEY (`event_id`) REFERENCES `AfroSympla_event` (`id`);

--
-- Constraints for table `AfroSympla_event_date_ticket`
--
ALTER TABLE `AfroSympla_event_date_ticket`
  ADD CONSTRAINT `FK_E8B0FCF9733DA6BA` FOREIGN KEY (`eventdate_id`) REFERENCES `AfroSympla_event_date` (`id`);

--
-- Constraints for table `AfroSympla_event_image`
--
ALTER TABLE `AfroSympla_event_image`
  ADD CONSTRAINT `FK_6A4E8E5E71F7E88B` FOREIGN KEY (`event_id`) REFERENCES `AfroSympla_event` (`id`);

--
-- Constraints for table `AfroSympla_event_language`
--
ALTER TABLE `AfroSympla_event_language`
  ADD CONSTRAINT `FK_DD794B6A88818ADD` FOREIGN KEY (`Event_id`) REFERENCES `AfroSympla_event` (`id`),
  ADD CONSTRAINT `FK_DD794B6A91E91181` FOREIGN KEY (`Language_Id`) REFERENCES `AfroSympla_language` (`id`);

--
-- Constraints for table `AfroSympla_event_subtitle`
--
ALTER TABLE `AfroSympla_event_subtitle`
  ADD CONSTRAINT `FK_5827AD6E88818ADD` FOREIGN KEY (`Event_id`) REFERENCES `AfroSympla_event` (`id`),
  ADD CONSTRAINT `FK_5827AD6E91E91181` FOREIGN KEY (`Language_Id`) REFERENCES `AfroSympla_language` (`id`);

--
-- Constraints for table `AfroSympla_event_translation`
--
ALTER TABLE `AfroSympla_event_translation`
  ADD CONSTRAINT `FK_2FCD2BD62C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_event` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_favorites`
--
ALTER TABLE `AfroSympla_favorites`
  ADD CONSTRAINT `FK_B853A82F88818ADD` FOREIGN KEY (`Event_id`) REFERENCES `AfroSympla_event` (`id`),
  ADD CONSTRAINT `FK_B853A82FFD57CEAB` FOREIGN KEY (`User_Id`) REFERENCES `AfroSympla_user` (`id`);

--
-- Constraints for table `AfroSympla_following`
--
ALTER TABLE `AfroSympla_following`
  ADD CONSTRAINT `FK_2D8545399F5D9622` FOREIGN KEY (`Organizer_id`) REFERENCES `AfroSympla_organizer` (`id`),
  ADD CONSTRAINT `FK_2D854539FD57CEAB` FOREIGN KEY (`User_Id`) REFERENCES `AfroSympla_user` (`id`);

--
-- Constraints for table `AfroSympla_help_center_article`
--
ALTER TABLE `AfroSympla_help_center_article`
  ADD CONSTRAINT `FK_75F977E312469DE2` FOREIGN KEY (`category_id`) REFERENCES `AfroSympla_help_center_category` (`id`);

--
-- Constraints for table `AfroSympla_help_center_article_translation`
--
ALTER TABLE `AfroSympla_help_center_article_translation`
  ADD CONSTRAINT `FK_54AB40302C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_help_center_article` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_help_center_category`
--
ALTER TABLE `AfroSympla_help_center_category`
  ADD CONSTRAINT `FK_9BE9AD17727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `AfroSympla_help_center_category` (`id`);

--
-- Constraints for table `AfroSympla_help_center_category_translation`
--
ALTER TABLE `AfroSympla_help_center_category_translation`
  ADD CONSTRAINT `FK_2B8AFEF52C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_help_center_category` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_homepage_hero_setting_translation`
--
ALTER TABLE `AfroSympla_homepage_hero_setting_translation`
  ADD CONSTRAINT `FK_5DD4B1372C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_homepage_hero_setting` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_language_translation`
--
ALTER TABLE `AfroSympla_language_translation`
  ADD CONSTRAINT `FK_E82162722C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_language` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_order`
--
ALTER TABLE `AfroSympla_order`
  ADD CONSTRAINT `FK_2F14A4F44C3A3BB` FOREIGN KEY (`payment_id`) REFERENCES `AfroSympla_payment` (`id`),
  ADD CONSTRAINT `FK_2F14A4F459CA0035` FOREIGN KEY (`paymentgateway_id`) REFERENCES `AfroSympla_payment_gateway` (`id`),
  ADD CONSTRAINT `FK_2F14A4F4A76ED395` FOREIGN KEY (`user_id`) REFERENCES `AfroSympla_user` (`id`);

--
-- Constraints for table `AfroSympla_order_element`
--
ALTER TABLE `AfroSympla_order_element`
  ADD CONSTRAINT `FK_261BAAD1182CEB62` FOREIGN KEY (`eventticket_id`) REFERENCES `AfroSympla_event_date_ticket` (`id`),
  ADD CONSTRAINT `FK_261BAAD18D9F6D38` FOREIGN KEY (`order_id`) REFERENCES `AfroSympla_order` (`id`);

--
-- Constraints for table `AfroSympla_order_ticket`
--
ALTER TABLE `AfroSympla_order_ticket`
  ADD CONSTRAINT `FK_111E8938EE04F0C1` FOREIGN KEY (`orderelement_id`) REFERENCES `AfroSympla_order_element` (`id`);

--
-- Constraints for table `AfroSympla_organizer`
--
ALTER TABLE `AfroSympla_organizer`
  ADD CONSTRAINT `FK_C5EEB9A9A76ED395` FOREIGN KEY (`user_id`) REFERENCES `AfroSympla_user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_C5EEB9A9F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `AfroSympla_country` (`id`);

--
-- Constraints for table `AfroSympla_organizer_category`
--
ALTER TABLE `AfroSympla_organizer_category`
  ADD CONSTRAINT `FK_BB88F7D715E3697` FOREIGN KEY (`Category_Id`) REFERENCES `AfroSympla_category` (`id`),
  ADD CONSTRAINT `FK_BB88F7D79F5D9622` FOREIGN KEY (`Organizer_id`) REFERENCES `AfroSympla_organizer` (`id`);

--
-- Constraints for table `AfroSympla_page_translation`
--
ALTER TABLE `AfroSympla_page_translation`
  ADD CONSTRAINT `FK_3B97CBF22C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_page` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_payment`
--
ALTER TABLE `AfroSympla_payment`
  ADD CONSTRAINT `FK_1CDDDF948D9F6D38` FOREIGN KEY (`order_id`) REFERENCES `AfroSympla_order` (`id`),
  ADD CONSTRAINT `FK_1CDDDF94F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `AfroSympla_country` (`id`);

--
-- Constraints for table `AfroSympla_payment_gateway`
--
ALTER TABLE `AfroSympla_payment_gateway`
  ADD CONSTRAINT `FK_9D4780D7876C4DDA` FOREIGN KEY (`organizer_id`) REFERENCES `AfroSympla_organizer` (`id`);

--
-- Constraints for table `AfroSympla_payout_request`
--
ALTER TABLE `AfroSympla_payout_request`
  ADD CONSTRAINT `FK_4AE2AE433DC09FC4` FOREIGN KEY (`event_date_id`) REFERENCES `AfroSympla_event_date` (`id`),
  ADD CONSTRAINT `FK_4AE2AE4362890FD5` FOREIGN KEY (`payment_gateway_id`) REFERENCES `AfroSympla_payment_gateway` (`id`),
  ADD CONSTRAINT `FK_4AE2AE43876C4DDA` FOREIGN KEY (`organizer_id`) REFERENCES `AfroSympla_organizer` (`id`);

--
-- Constraints for table `AfroSympla_pointofsale`
--
ALTER TABLE `AfroSympla_pointofsale`
  ADD CONSTRAINT `FK_5D78D6FA876C4DDA` FOREIGN KEY (`organizer_id`) REFERENCES `AfroSympla_organizer` (`id`),
  ADD CONSTRAINT `FK_5D78D6FAA76ED395` FOREIGN KEY (`user_id`) REFERENCES `AfroSympla_user` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_review`
--
ALTER TABLE `AfroSympla_review`
  ADD CONSTRAINT `FK_3D9D918271F7E88B` FOREIGN KEY (`event_id`) REFERENCES `AfroSympla_event` (`id`),
  ADD CONSTRAINT `FK_3D9D9182A76ED395` FOREIGN KEY (`user_id`) REFERENCES `AfroSympla_user` (`id`);

--
-- Constraints for table `AfroSympla_scanner`
--
ALTER TABLE `AfroSympla_scanner`
  ADD CONSTRAINT `FK_241A84B0876C4DDA` FOREIGN KEY (`organizer_id`) REFERENCES `AfroSympla_organizer` (`id`),
  ADD CONSTRAINT `FK_241A84B0A76ED395` FOREIGN KEY (`user_id`) REFERENCES `AfroSympla_user` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_ticket_reservation`
--
ALTER TABLE `AfroSympla_ticket_reservation`
  ADD CONSTRAINT `FK_716DEA9F182CEB62` FOREIGN KEY (`eventticket_id`) REFERENCES `AfroSympla_event_date_ticket` (`id`),
  ADD CONSTRAINT `FK_716DEA9FA76ED395` FOREIGN KEY (`user_id`) REFERENCES `AfroSympla_user` (`id`),
  ADD CONSTRAINT `FK_716DEA9FEE04F0C1` FOREIGN KEY (`orderelement_id`) REFERENCES `AfroSympla_order_element` (`id`);

--
-- Constraints for table `AfroSympla_user`
--
ALTER TABLE `AfroSympla_user`
  ADD CONSTRAINT `FK_D01C6A2218E07BF3` FOREIGN KEY (`pointofsale_id`) REFERENCES `AfroSympla_pointofsale` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_D01C6A2267C89E33` FOREIGN KEY (`scanner_id`) REFERENCES `AfroSympla_scanner` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_D01C6A22876C4DDA` FOREIGN KEY (`organizer_id`) REFERENCES `AfroSympla_organizer` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_D01C6A22F2709FF9` FOREIGN KEY (`isorganizeronhomepageslider_id`) REFERENCES `AfroSympla_homepage_hero_setting` (`id`),
  ADD CONSTRAINT `FK_D01C6A22F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `AfroSympla_country` (`id`);

--
-- Constraints for table `AfroSympla_venue`
--
ALTER TABLE `AfroSympla_venue`
  ADD CONSTRAINT `FK_4BAC2C61876C4DDA` FOREIGN KEY (`organizer_id`) REFERENCES `AfroSympla_organizer` (`id`),
  ADD CONSTRAINT `FK_4BAC2C61C54C8C93` FOREIGN KEY (`type_id`) REFERENCES `AfroSympla_venue_type` (`id`),
  ADD CONSTRAINT `FK_4BAC2C61F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `AfroSympla_country` (`id`);

--
-- Constraints for table `AfroSympla_venue_amenity`
--
ALTER TABLE `AfroSympla_venue_amenity`
  ADD CONSTRAINT `FK_8A89D31E45463477` FOREIGN KEY (`Amenity_Id`) REFERENCES `AfroSympla_amenity` (`id`),
  ADD CONSTRAINT `FK_8A89D31EB9D15CEC` FOREIGN KEY (`Venue_id`) REFERENCES `AfroSympla_venue` (`id`);

--
-- Constraints for table `AfroSympla_venue_image`
--
ALTER TABLE `AfroSympla_venue_image`
  ADD CONSTRAINT `FK_F3EE32A540A73EBA` FOREIGN KEY (`venue_id`) REFERENCES `AfroSympla_venue` (`id`);

--
-- Constraints for table `AfroSympla_venue_translation`
--
ALTER TABLE `AfroSympla_venue_translation`
  ADD CONSTRAINT `FK_3A06BD632C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_venue` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_venue_type_translation`
--
ALTER TABLE `AfroSympla_venue_type_translation`
  ADD CONSTRAINT `FK_9FD9786F2C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_venue_type` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `AfroSympla_vote`
--
ALTER TABLE `AfroSympla_vote`
  ADD CONSTRAINT `FK_79F390FEBB4B8AD` FOREIGN KEY (`voter_id`) REFERENCES `AfroSympla_user` (`id`),
  ADD CONSTRAINT `FK_79F390FF8697D13` FOREIGN KEY (`comment_id`) REFERENCES `AfroSympla_comment` (`id`);
COMMIT;

--
-- Constraints for table `AfroSympla_menu_translation`
--
ALTER TABLE `AfroSympla_menu_translation`
  ADD CONSTRAINT `FK_44D78BCC2C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_menu` (`id`) ON DELETE CASCADE;
COMMIT;

--
-- Constraints for table `AfroSympla_menu_element`
--
ALTER TABLE `AfroSympla_menu_element`
  ADD CONSTRAINT `FK_8CAA77C9CCD7E912` FOREIGN KEY (`menu_id`) REFERENCES `AfroSympla_menu` (`id`);
COMMIT;

--
-- Constraints for table `AfroSympla_menu_element_translation`
--
ALTER TABLE `AfroSympla_menu_element_translation`
  ADD CONSTRAINT `FK_CEDB3B232C2AC5D3` FOREIGN KEY (`translatable_id`) REFERENCES `AfroSympla_menu_element` (`id`) ON DELETE CASCADE;
COMMIT;

CREATE UNIQUE INDEX UNIQ_E0F45684D2D95D97 ON AfroSympla_currency (ccy);
