 ...
 * @ORM\Table(name="AfroSympla_scanner")
 */
class Scanner {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Organizer", inversedBy="scanners")
     */
    private $organizer;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="EventDate", mappedBy="scanners")
     */
    private $eventdates;
