 ...
 * @ORM\Table(name="AfroSympla_venue")
...
class Venue {
    ...
    /**
     * @ORM\OneToMany(targetEntity="VenueSeatingPlan", mappedBy="venue", cascade={"persist", "remove"}, orphanRemoval=true)
     */
     ...
     * @ORM\JoinTable(name="AfroSympla_venue_amenity",
...
// set the owning side to null (unless already changed)
    ...
    /**
     * @return Collection|VenueSeatingPlan[]
     */
    ...
    public function addSeatingPlan(VenueSeatingPlan $seatingPlan): self
    {
    ...
    public function removeSeatingPlan(VenueSeatingPlan $seatingPlan): self
    {
        if ($this->seatingPlans->contains($seatingPlan)) {
            $this->seatingPlans->removeElement($seatingPlan);
            // set the owning side to null (unless already changed)
